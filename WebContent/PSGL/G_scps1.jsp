 ...
 <body background="/yuntong/picture/bk3.jpg" topmargin="0" marginheight="0" leftmargin="0" rightmargin="0" marginwidth="0">
	 ...
	 <table width="984" BORDER=0 CELLSPACING=0 CELLPADDING=0>    	
    	<tr>
    		...
    		<td valign="top" align="left" width="88%">
    			<!-- 中间内容（开始） -->
    				...
    				<table border="0" cellpadding="0" cellspacing="0" class="tx" width="100%">
    					<tr>
    						<td>当前位置:>><a href="/yuntong/y_GoIndex">首页</a>>>市内配送</td>
    					</tr>
			...
			<tr>
			<td valign="top"><br><br>
			<table width="100%" border="0" class="tx" cellpadding="0" cellspacing="0" >
				<tr>
					<td bgcolor="a0c0c0">
						<table width="100%" border="0">
							...
							<tr>
								<td>
									选择配送地区&nbsp;&nbsp;:&nbsp;&nbsp;
									<select class="tx" name="market" id="market">
										<option value="没有选择市场">选择市场</option>
								      	<c:forEach items="${marketInfoList}" var="marketInfoList">
								      		<option value="${marketInfoList.marketName}">${marketInfoList.marketName}</option>
								      	</c:forEach>
							         </select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;							     
							         <input type="button" value="确定" class="txt1" onclick="getParticularInfo();">
								</td>
							</tr>
						</table>
	               ...
	               <table border="1" cellpadding="0" cellspacing="0" width="100%">
	              	...
	              	<tr>
	              		<td colspan="2" id="next" align="center">
	              			<form action="/yuntong/PSGL/g_GoSNPS2" method="post">
